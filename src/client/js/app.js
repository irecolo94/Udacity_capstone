function genAnswer(event) {
    ...
    let newFeel = document.getElementById('feelings').value;
    ...
    fetch('http://localhost:4041/results', {
          ...
          .then(function(res) {
            ...
            document.getElementById('city').innerHTML = 'your Zipcode corrisponds to: ' + res.city;
            document.getElementById('temp').innerHTML = 'temperature: ' + res.temperature;
            document.getElementById('content').innerHTML = 'your feeling: ' + newFeel;
            console.log(res)
          })
